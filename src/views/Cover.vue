        ...
        return {
            ...
            audio: {
                normal: {
                    indo: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/cover/indo/big font cover (indo).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-2/indo/(R) teks spread 2 indo 1.svg"
                        },
                    ],
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/cover/english/big font cover (english).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-2/indo/(R) teks spread 2 indo 1.svg"
                        }
                    ],
                },
                big: {
                    ...
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/cover/english/cover (english).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-2/indo/(R) teks spread 2 indo 1.svg"
                        }
                    ],
                }
...
<template>
    <main>
        <div class="page-layout">
            ...
            <video 
                v-if="!playLoop && languageStore.language === 'indo'" 
                autoplay 
                muted 
            ...
            <video 
                v-if="!playLoop && languageStore.language === 'english'" 
                autoplay 
                muted 
                class="entrance-video" 
                @ended="onVideoEnd()"
            >
                <source src="@/assets/video/Cover English - Entrance _ Hold.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
            <video 
                v-if="!playLoop && languageStore.language === 'malay'" 
                autoplay 
                muted 
                class="entrance-video" 
                @ended="onVideoEnd()"
            ...
            <!-- <video v-if="!playLoop" autoplay muted class="entrance-video" @ended="onVideoEnd()">
                <source src="@/assets/video/Spread 7 - Entrance.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
            ...
            <!-- <img refs="temp-image" src="@/assets/temp/cover.jpg" class="temp-image"/> -->
