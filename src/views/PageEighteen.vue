...
export default {
        ...
        return {
            ...
            audio: {
                normal: {
                    indo: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/indo/(R) big font spread 18 (indo 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/indo/(R) teks spread 18 indo 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/indo/(R) big font spread 18 (indo 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/indo/(R) teks spread 18 indo 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/indo/(R) big font spread 18 (indo 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/indo/(R) teks spread 18 indo 2.svg"
                        }
                    ],
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/english/big font spread 18 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/english/(R) teks spread 18 english 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/english/big font spread 18 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/english/(R) teks spread 18 english 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/english/big font spread 18 (english 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/english/(R) teks spread 18 english 2.svg"
                        }
                    ],
                    malay: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/english/big font spread 18 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/malay/(R) teks spread 18 malay 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/english/big font spread 18 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/malay/(R) teks spread 18 malay 1.svg"
                        ...
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/english/big font spread 18 (english 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/malay/(R) teks spread 18 malay 2.svg"
                        }
                    ],
                },
                big: {
                    indo: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/indo/(R) big font spread 18 (indo 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/indo/(R) teks big spread 18 indo 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/indo/(R) big font spread 18 (indo 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/indo/(R) teks big spread 18 indo 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/indo/(R) big font spread 18 (indo 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/indo/(R) teks big spread 18 indo 3.svg"
                        }
                    ],
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/english/big font spread 18 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/english/(R) teks big spread 18 english 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/english/big font spread 18 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/english/(R) teks big spread 18 english 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/english/big font spread 18 (english 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/english/(R) teks big spread 18 english 3.svg"
                        }
                    ],
                    malay: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/english/big font spread 18 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/malay/(R) teks big spread 18 malay 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/english/big font spread 18 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/malay/(R) teks big spread 18 malay 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-18/english/big font spread 18 (english 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-18/malay/(R) teks big spread 18 malay 3.svg"
                        }
                    ],
                }
            },
    ...
    mounted() {
        ...
        // bgm.src = this.linkBaseStore.linkBase + "src/assets/audio/music/Spread 17 - Spread 18.wav";
        ...
        onNextBtn() {
            ...
            const fadeOut = (timestamp) => {
                ...
                if (progress < 1700) {
                    ...
                    this.$router.push("/page-nineteen");
                }
            }
    ...
    <main>
        <div class="page-layout">
            ...
            <video v-if="!playLoop" autoplay muted class="entrance-video" @ended="onVideoEnd()">
                <source src="@/assets/video/Spread 18 - Entrance.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
            <video autoplay loop muted ref="loop-video" class="loop-video" @ended="onHoldEnd()">
                <source src="@/assets/video/Spread 18 - Loop.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
            ...
            <!-- <img refs="temp-image" src="@/assets/temp/spread 18 (3).jpg" class="temp-image"/> -->
