        ...
        return {
            ...
            audio: {
                normal: {
                    indo: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-5/indo/(R) big font spread 5 (indo 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-5/indo/(R) teks spread 5 indo.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-5/indo/(R) big font spread 5 (indo 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-5/indo/(R) teks spread 5 indo.svg"
                        }
                    ],
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-5/english/big font spread 5 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-5/english/(R) teks spread 5 english.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-5/english/big font spread 5 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-5/english/(R) teks spread 5 english.svg"
                        }
                    ],
                    malay: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-5/english/big font spread 5 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-5/malay/(R) teks spread 5 malay.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-5/english/big font spread 5 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-5/malay/(R) teks spread 5 malay.svg"
                ...
                big: {
                    indo: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-5/indo/(R) big font spread 5 (indo 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-5/indo/(R) teks big spread 5 indo 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-5/indo/(R) big font spread 5 (indo 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-5/indo/(R) teks big spread 5 indo 2.svg"
                        }
                    ],
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-5/english/big font spread 5 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-5/english/(R) teks big spread 5 english 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-5/english/big font spread 5 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-5/english/(R) teks big spread 5 english 2.svg"
                        }
                    ],
                    malay: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-5/english/big font spread 5 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-5/malay/(R) teks big spread 5 malay 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-5/english/big font spread 5 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-5/malay/(R) teks big spread 5 malay 2.svg"
                        }
                    ] 
                }
            },
    ...
    <main>
        <div class="page-layout">
            ...
            <video v-if="!playLoop" autoPlay muted class="entrance-video" @ended="onVideoEnd()">
                <source src="@/assets/video/Spread 5 - Entrance & Hold_REVISI.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
            <video muted ref="loop-video" class="loop-video">
                <source src="@/assets/video/Spread 4 - After Hold.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
