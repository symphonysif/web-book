        ...
        return {
            ...
            audio: {
                normal: {
                    indo: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-14/indo/(R) big font spread 14 (indo).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-14/indo/(R) teks spread 14 indo.svg"
                        }
                    ],
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-14/english/big font spread 14 (english).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-14/english/(R) teks spread 14 english.svg"
                        }
                    ],
                    malay: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-14/english/big font spread 14 (english).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-14/malay/(R) teks spread 14 malay.svg"
                        }
                    ],
                },
                big: {
                    indo: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-14/indo/(R) big font spread 14 (indo).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-14/indo/(R) teks big spread 14 indo.svg"
                        }
                    ],
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-14/english/big font spread 14 (english).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-14/english/(R) teks big spread 14 english.svg"
                        }
                    ],
                    malay: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-14/english/big font spread 14 (english).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-14/malay/(R) teks big spread 14 malay.svg"
                        }
                    ],
                }
            },
...
<template>
    <main>
        <div class="page-layout">
            ...
            <!-- <img refs="temp-image" src="@/assets/temp/spread 14 no outline (2).jpg" class="temp-image"/> -->
