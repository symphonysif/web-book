    ...
    <main>
        <div class="page-layout">
            <audio ref="sound" id="sound">
                <source src="@/assets/audio/storytelling/spread-2/indo/spread 2 (indo 1).mp3" type="audio/mp3">
            </audio>
            <video v-if="!playLoop" autoplay muted class="entrance-video" @ended="onVideoEnd()">
                <source src="@/assets/video/Spread 1 - Entrance _ Hold.mp4" type="video/mp4">
            ...
            <!-- <img refs="temp-image" src="@/assets/temp/Spread 1 brown.jpg" class="temp-image"/> -->
