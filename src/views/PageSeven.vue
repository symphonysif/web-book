...
export default {
    ...
    data() {
        return {
            ...
            texts: {
                normal: {
                    indo: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-7/indo/teks spread 7 (instruksi indo).svg",
                        this.linkBaseStore.linkBase + "src/assets/text/spread-7/indo/teks spread 7 indo.svg",
                    ],
                    english: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-7/english/teks spread 7 (instruksi english).svg",
                        this.linkBaseStore.linkBase + "src/assets/text/spread-7/english/teks spread 7 english.svg",
                    ],
                    malay: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-7/malay/teks spread 7 (instruksi malay).svg",
                        this.linkBaseStore.linkBase + "src/assets/text/spread-7/malay/teks spread 7 malay.svg",
                    ],
                },
                big: {
                    indo: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-7/indo/teks spread big 7 (instruksi indo).svg",
                        this.linkBaseStore.linkBase + "src/assets/text/spread-7/indo/teks spread big 7 indo.svg",
                    ],
                    english: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-7/english/teks spread big 7 (instruksi english).svg",
                        this.linkBaseStore.linkBase + "src/assets/text/spread-7/english/teks spread big 7 english.svg",
                    ],
                    malay: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-7/malay/teks spread big 7 (instruksi malay).svg",
                        this.linkBaseStore.linkBase + "src/assets/text/spread-7/malay/teks spread big 7 malay.svg",
                    ],
                }
            }
        }
    ...
    mounted() {
        ...
        bgm.src = this.linkBaseStore.linkBase + "src/assets/audio/music/Spread 7.wav";
    ...
    <main>
        <div class="page-layout">
            ...
            <video v-if="!playLoop" autoplay muted class="entrance-video" @ended="onVideoEnd()">
                <source src="@/assets/video/(R) Spread 7 - Entrance.mp4" type="video/mp4">
