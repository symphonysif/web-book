...
export default {
    ...
    data() {
        return {
            ...
            texts: {
                normal: {
                    indo: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-17/indo/(R) teks spread 17 indo.svg"
                    ],
                    english: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-17/english/(R) teks spread 17 english.svg"
                    ], 
                    malay: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-17/malay/(R) teks spread 17 malay.svg"
                    ],
                },
                big: {
                    indo: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-17/indo/(R) teks big spread 17 indo.svg"
                    ],
                    english: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-17/english/(R) teks big spread 17 english.svg"
                    ],
                    malay: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-17/malay/(R) teks big spread 17 malay.svg"
                    ],
                }
            }
        }
    ...
    methods: {
        ...
        onNextBtn() {
            ...
            this.$router.push("/page-eighteen");
    ...
    <main>
        <div class="page-layout">
            ...
            <video v-if="!playLoop" muted class="entrance-video" @ended="onVideoEnd()">
                <source src="@/assets/video/(R) Spread 17 - Entrance & Hold.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
            <video loop muted ref="loop-video" class="loop-video" @ended="onHoldEnd()">
                <source src="@/assets/video/Spread 17 - Loop.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
            <span v-if="showInteractive" class="interactive">
                <button id="interactive-1" @click="onInteractiveClick(0)">
                </button>
                <img src="@/assets/image/spread-17/(R) spread 17 - perahu (untuk di-klik).svg">
            </span>
            ...
            <!-- <img refs="temp-image" src="@/assets/temp/spread 17.jpg" class="temp-image"/> -->
