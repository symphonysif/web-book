...
export default {
    ...
    data() {
        return {
            ...
            texts: {
                normal: {
                    indo: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-10/indo/teks spread 10 (instruksi indo).svg",
                        this.linkBaseStore.linkBase + "src/assets/text/spread-10/indo/teks spread 10 english indo.svg",
                    ],
                    english: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-10/english/teks spread 10 (instruksi english).svg",
                        this.linkBaseStore.linkBase + "src/assets/text/spread-10/english/teks spread 10 english indo.svg",
                    ],
                    malay: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-10/malay/teks spread 10 (instruksi malay).svg",
                        this.linkBaseStore.linkBase + "src/assets/text/spread-10/malay/teks spread 10 malay.svg",
                    ],
                },
                big: {
                    indo: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-10/indo/teks spread big 10 (instruksi indo).svg",
                        this.linkBaseStore.linkBase + "src/assets/text/spread-10/indo/teks spread big 10 english indo.svg",
                    ],
                    english: [
                        this.linkBaseStore.linkBase + "src/assets/text/spread-10/english/teks spread 10 (instruksi english).svg",
                        this.linkBaseStore.linkBase + "src/assets/text/spread-10/english/teks spread 10 english indo.svg",
    ...
    mounted() {
        ...
        bgm.src = this.linkBaseStore.linkBase + "src/assets/audio/music/Spread 10.wav";
    ...
    methods: {
        onVideoEnd() {
            setTimeout(() => {
                ...
                // }
                this.playLoop = true;
                const loopVideo = this.$refs["loop-video"];
                loopVideo.play();
                this.$refs['next-btn'].style.visibility = "visible";
        ...
        onInteractiveClick(index) {
            ...
            if( this.flag.every((value) => value === true)) {
                const entranceVideo  = document.getElementsByClassName("entrance-video")[0];
                entranceVideo.play();
                this.showInteractive = false;
                this.changeText(1);
...
<template>
    <main>
        <div class="page-layout">
            ...
            <video v-if="!playLoop" muted class="entrance-video" @ended="onVideoEnd()">
                <source src="@/assets/video/Spread 10 - Entrance Post Rev.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
            <video muted loop ref="loop-video" class="loop-video">
                <source src="@/assets/video/Spread 10 - Loop Post Rev.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
            <span v-if="showInteractive" class="interactive">
                <button id="interactive-1" @click="onInteractiveClick(0)">
                </button>
                <button id="interactive-2" @click="onInteractiveClick(1)">
                </button>
                <button id="interactive-3" @click="onInteractiveClick(2)">
                </button>
                <img src="@/assets/image/spread-10/spread 10 - tokoh macan batik (untuk di-klik).svg">
                <img src="@/assets/image/spread-10/spread 10 - tokoh macan utama (untuk di-klik).svg">
                <img src="@/assets/image/spread-10/spread 10 - tokoh macan wayang (untuk di-klik).svg">
            </span>
            ...
            <!-- <img refs="temp-image" src="@/assets/temp/spread 10 (copy).jpg" class="temp-image"/> -->
