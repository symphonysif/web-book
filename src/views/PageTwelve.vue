        ...
        return {
            ...
            audio: {
                normal: {
                    indo: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/indo/(R) big font spread 12 (indo 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/indo/(R) teks spread 12 indo 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/indo/(R) big font spread 12 (indo 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/indo/(R) teks spread 12 indo 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/indo/(R) big font spread 12 (indo 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/indo/(R) teks spread 12 indo 2.svg"
                        }
                    ],
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/english/big font spread 12 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/english/(R) teks spread 12 english 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/english/big font spread 12 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/english/(R) teks spread 12 english 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/english/big font spread 12 (english 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/english/(R) teks spread 12 english 2.svg"
                        }
                    ],
                    malay: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/english/big font spread 12 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/malay/(R) teks spread 12 malay 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/english/big font spread 12 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/malay/(R) teks spread 12 malay 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/english/big font spread 12 (english 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/malay/(R) teks spread 12 malay 2.svg"
                ...
                big: {
                    indo: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/indo/(R) big font spread 12 (indo 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/indo/(R) teks big spread 12 indo 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/indo/(R) big font spread 12 (indo 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/indo/(R) teks big spread 12 indo 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/indo/(R) big font spread 12 (indo 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/indo/(R) teks big spread 12 indo 3.svg"
                        }
                    ],
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/english/big font spread 12 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/english/(R) teks big spread 12 english 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/english/big font spread 12 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/english/(R) teks big spread 12 english 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/english/big font spread 12 (english 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/english/(R) teks big spread 12 english 3.svg"
                        }
                    ],
                    malay: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/english/big font spread 12 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/malay/(R) teks big spread 12 malay 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/english/big font spread 12 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/malay/(R) teks big spread 12 malay 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-12/english/big font spread 12 (english 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-12/malay/(R) teks big spread 12 malay 3.svg"
                        }
                    ],
                }
            },
        ...
        onNextBtn() {
            ...
            const fadeOut = (timestamp) => {
                ...
                if (progress < 1700) {
                    ...
                    this.$router.push("/page-thirteen");
                }
            }
    ...
    <main>
        <div class="page-layout">
            ...
            <video v-if="!playLoop" autoplay muted class="entrance-video" @ended="onVideoEnd()">
                <source src="@/assets/video/Spread 12 - Entrance.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
            <video muted ref="loop-video" class="loop-video" @ended="onHoldEnd()">
                <source src="@/assets/video/Spread 12 - Loop.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
            ...
            <!-- <img refs="temp-image" src="@/assets/temp/spread 12.jpg" class="temp-image"/> -->
