        ...
        return {
            ...
            audio: {
                normal: {
                    indo: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/indo/(R) big font spread 20 (indo 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/indo/(R) teks spread 20 indo 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/indo/(R) big font spread 20 (indo 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/indo/(R) teks spread 20 indo 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/indo/(R) big font spread 20 (indo 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/indo/(R) teks spread 20 indo 3.svg"
                        },
                    ],
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/english/big font spread 20 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/english/(R) teks spread 20 english 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/english/big font spread 20 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/english/(R) teks spread 20 english 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/english/big font spread 20 (english 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/english/(R) teks spread 20 english 3.svg"
                        },
                    ],
                    malay: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/english/big font spread 20 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/malay/(R) teks spread 20 malay 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/english/big font spread 20 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/malay/(R) teks spread 20 malay 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/english/big font spread 20 (english 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/malay/(R) teks spread 20 malay 3.svg"
                        },
                    ],
                },
                big: {
                    indo: [
                        ...
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/indo/(R) big font spread 20 (indo 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/indo/(R) teks big spread 20 indo 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/indo/(R) big font spread 20 (indo 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/indo/(R) teks big spread 20 indo 3.svg"
                        },
                    ],
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/english/big font spread 20 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/english/(R) teks big spread 20 english 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/english/big font spread 20 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/english/(R) teks big spread 20 english 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/english/big font spread 20 (english 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/english/(R) teks big spread 20 english 3.svg"
                        },
                    ],
                    malay: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/english/big font spread 20 (english 1).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/malay/(R) teks big spread 20 malay 1.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/english/big font spread 20 (english 2).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/malay/(R) teks big spread 20 malay 2.svg"
                        },
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-20/english/big font spread 20 (english 3).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-20/malay/(R) teks big spread 20 malay 3.svg"
                        },
                    ],
                }
            },
    ...
    <main>
        <div class="page-layout">
            ...
            <video v-if="!playLoop" autoplay muted class="entrance-video" @ended="onVideoEnd()">
                <source src="@/assets/video/Spread 20 - Entrance.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
            <video autoplay loop muted ref="loop-video" class="loop-video" @ended="onHoldEnd()">
                <source src="@/assets/video/Spread 20 - Loop.mp4" type="video/mp4">
                Your browser does not support the video tag
            </video>
            ...
            <!-- <img refs="temp-image" src="@/assets/temp/spread 20.jpg" class="temp-image"/> -->
