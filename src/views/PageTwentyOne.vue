        ...
        return {
            ...
            audio: {
                normal: {
                    indo: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-21/indo/big font spread 21 (indo).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-21/indo/(R) teks spread 21 indo.svg"
                        }
                    ],
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-21/english/big font spread 21 (english).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-21/english/(R) teks spread 21 english.svg"
                        }
                    ], 
                    malay: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-21/english/big font spread 21 (english).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-21/malay/(R) teks spread 21 malay.svg"
                        }
                    ],
                },
                big: {
                    indo: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-21/indo/big font spread 21 (indo).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-21/indo/(R) teks big spread 21 indo.svg"
                        }
                    ],
                    english: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-21/english/big font spread 21 (english).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-21/english/(R) teks big spread 21 english.svg"
                        }
                    ],
                    malay: [
                        {
                            soundSource: this.linkBaseStore.linkBase + "src/assets/audio/storytelling/spread-21/english/big font spread 21 (english).mp3",
                            textSource: this.linkBaseStore.linkBase + "src/assets/text/spread-21/malay/(R) teks big spread 21 malay.svg"
                        }
                    ],
                }
            },
        ...
        onNextBtn() {
            ...
            const fadeOut = (timestamp) => {
                ...
                if (progress < 1700) {
                    ...
                    this.$router.push("/page-thank-you");
                }
            }
...
<template>
    <main>
        <div class="page-layout">
            ...
            <video loop v-if="!playLoop" autoplay muted class="entrance-video" @ended="onVideoEnd()">
            ...
            <!-- <img refs="temp-image" src="@/assets/temp/spread 21 (fin).jpg" class="temp-image"/> -->
